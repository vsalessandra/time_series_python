...
def repete(n):
      def decorator(func): #vai receber a funcao decorada
            @wraps(func) #decorador
            def wrapper(*args, **kwargs): #funcao decorada, aceita qualquer tipo de arg
                  for _ in range(n):
                        i = func(*args, **kwargs) #funcao original e chamada e gaurda o ultimo resultado
                  return i
            return wrapper
      return decorator
